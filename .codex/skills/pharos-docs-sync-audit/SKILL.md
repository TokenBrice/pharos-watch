...
If the user asks for a broad docs update pass or explicitly requests subagents, use `references/subagents.md` to split the audit by docs family. Subagents should be read-only unless assigned a narrow doc write set.
