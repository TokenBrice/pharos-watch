...
8. Converge the aggregate and dependent projections with `npm run bootstrap:generated`, then run `npm run check:stablecoin-data`; for full additions, follow Phase 7 in `docs/process/adding-a-stablecoin.md`.
