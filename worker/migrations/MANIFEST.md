...
| 0195     | `0195_telegram_adoption_client_quota.sql`                     | Add hashed-IP per-client minute quotas for public PharosWatchBot CTA telemetry                                                                           |
...
- `0195_telegram_adoption_client_quota.sql`: roll back per-client CTA quota enforcement by restoring the prior Pages version. Keep the additive hashed-IP quota table for forensic inspection; older Pages code ignores it and no raw IP addresses are stored.
