...
export const REPORT_CARD_EVIDENCE_JOURNAL_STORE_MAX_BATCH_RECORDS = 48;
export const REPORT_CARD_EVIDENCE_JOURNAL_STORE_MAX_BATCH_BYTES = 64 * 1_024;
export const REPORT_CARD_EVIDENCE_JOURNAL_STORE_MAX_RECORD_BYTES = 1_280;
