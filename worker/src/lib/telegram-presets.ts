...
import type { ResolvedCoin } from "./telegram-alerts";
...
export function getTelegramPresetDefinition(
  presetId: string,
): TelegramPresetDefinition | null {
  return PRESET_BY_ID.get(presetId as TelegramPresetId) ?? null;
}
