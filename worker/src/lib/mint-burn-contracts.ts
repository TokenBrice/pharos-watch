...
export const MINT_BURN_CONFIGS: MintBurnContractConfig[] = [
  // --- Safe havens ---
  {
    chain: ETHEREUM, stablecoinId: "usdt-tether", symbol: "USDT",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdc-circle", symbol: "USDC",
  ...
  {
    chain: ETHEREUM, stablecoinId: "fdusd-first-digital", symbol: "FDUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "pyusd-paypal", symbol: "PYUSD",
  ...
  // --- Risky / crypto-backed ---
  {
    chain: ETHEREUM, stablecoinId: "dai-makerdao", symbol: "DAI",
    contractAddress: "0x6b175474e89094c44da98b954eedeac495271d0f",
    decimals: 18, dustThreshold: 10_000, startBlock: 21_900_000,
    events: transferMintBurn(),
  },
  {
    chain: ETHEREUM, stablecoinId: "gho-aave", symbol: "GHO",
    contractAddress: "0x40d16fc0246ad3160ccc09b8d0d3a2cd28ae6c2f",
    decimals: 18, dustThreshold: 10_000, startBlock: 21_900_000,
    events: transferMintBurn(),
  },
  {
    chain: ETHEREUM, stablecoinId: "usde-ethena", symbol: "USDe",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usds-sky", symbol: "USDS",
    contractAddress: "0xdc035d45d973e3ec169d2276ddab16f1e407384f",
    decimals: 18, dustThreshold: 10_000, startBlock: 21_900_000,
    events: transferMintBurn(),
  },
  {
    chain: ETHEREUM, stablecoinId: "frxusd-frax", symbol: "FRXUSD",
    contractAddress: "0xcacd6fd266af91b8aed52accc382b4e165586e29",
    decimals: 18, dustThreshold: 10_000, startBlock: 21_900_000,
    events: transferMintBurn(),
  },
  {
    chain: ETHEREUM, stablecoinId: "bold-liquity", symbol: "BOLD",
    contractAddress: "0x6440f144b7e50d6a8439336510312d2f54beb01d",
    decimals: 18, dustThreshold: 10_000, startBlock: 21_900_000,
    events: transferMintBurn(),
  },
  {
    chain: ETHEREUM, stablecoinId: "fxusd-f-x-protocol", symbol: "fxUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "crvusd-curve", symbol: "crvUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "ausd-agora", symbol: "AUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "zchf-frankencoin", symbol: "ZCHF",
  ...
  {
    chain: ETHEREUM, stablecoinId: "eurc-circle", symbol: "EURC",
  ...
  {
    chain: ETHEREUM, stablecoinId: "paxg-paxos", symbol: "PAXG",
  ...
  {
    chain: ETHEREUM, stablecoinId: "xaut-tether", symbol: "XAUT",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdg-paxos", symbol: "USDG",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usd1-world-liberty-financial", symbol: "USD1",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdf-falcon", symbol: "USDf",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usyc-hashnote", symbol: "USYC",
  ...
  {
    chain: ETHEREUM, stablecoinId: "rlusd-ripple", symbol: "RLUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdy-ondo-finance", symbol: "USDY",
  ...
  {
    chain: ETHEREUM, stablecoinId: "buidl-blackrock", symbol: "BUIDL",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdd-tron-dao-reserve", symbol: "USDD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdtb-ethena", symbol: "USDTB",
  ...
  {
    chain: ETHEREUM, stablecoinId: "m-m0", symbol: "M",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usd0-usual", symbol: "USD0",
  ...
  {
    chain: ETHEREUM, stablecoinId: "tusd-trueusd", symbol: "TUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "cusd-cap", symbol: "CUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usr-resolv", symbol: "USR",
  ...
  {
    chain: ETHEREUM, stablecoinId: "frax-frax", symbol: "FRAX",
  ...
  {
    chain: ETHEREUM, stablecoinId: "dola-inverse-finance", symbol: "DOLA",
  ...
  {
    chain: ETHEREUM, stablecoinId: "iusd-infinifi", symbol: "IUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "gusd-gate", symbol: "GUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "avusd-avant", symbol: "avUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "pmusd-precious-metals", symbol: "pmUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdz-anzen", symbol: "USDz",
  ...
  {
    chain: ETHEREUM, stablecoinId: "mnee-mnee", symbol: "MNEE",
  ...
  {
    chain: ETHEREUM, stablecoinId: "tbill-openeden", symbol: "TBILL",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdo-openeden", symbol: "USDO",
  ...
  {
    chain: ETHEREUM, stablecoinId: "eurcv-societe-generale-forge", symbol: "EURCV",
  ...
  {
    chain: ETHEREUM, stablecoinId: "reusd-resupply", symbol: "REUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "euri-banking-circle", symbol: "EURI",
  ...
  {
    chain: ETHEREUM, stablecoinId: "gusd-gemini", symbol: "GUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdp-paxos", symbol: "USDP",
  ...
  {
    chain: ETHEREUM, stablecoinId: "xusd-straitsx", symbol: "XUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "musd-metamask", symbol: "MUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "yusd-aegis", symbol: "YUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "susd-synthetix", symbol: "SUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "lusd-liquity", symbol: "LUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdcv-societe-generale-forge", symbol: "USDCV",
  ...
  {
    chain: ETHEREUM, stablecoinId: "eure-monerium", symbol: "EURE",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usn-noon", symbol: "USN",
  ...
  {
    chain: ETHEREUM, stablecoinId: "eusd-electronic-usd", symbol: "EUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "eura-angle", symbol: "EURA",
  ...
  {
    chain: ETHEREUM, stablecoinId: "meusd-mezo", symbol: "meUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "msusd-metronome", symbol: "MSUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "nusd-neutrl", symbol: "NUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "alusd-alchemix", symbol: "ALUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "fidd-fidelity", symbol: "FIDD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "msusd-main-street", symbol: "MSUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "wusd-worldwide", symbol: "WUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "sbc-brale", symbol: "SBC",
  ...
  {
    chain: ETHEREUM, stablecoinId: "ousd-origin-protocol", symbol: "OUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usp-pikudao", symbol: "USP",
  ...
  {
    chain: ETHEREUM, stablecoinId: "usdr-stablr", symbol: "USDR",
  ...
  {
    chain: ETHEREUM, stablecoinId: "ustb-superstate", symbol: "USTB",
  ...
  {
    chain: ETHEREUM, stablecoinId: "ousg-ondo-finance", symbol: "OUSG",
  ...
  {
    chain: ETHEREUM, stablecoinId: "mtbill-midas", symbol: "mTBILL",
  ...
  {
    chain: ETHEREUM, stablecoinId: "wsrusd-reservoir", symbol: "wsrUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "audd-novatti", symbol: "AUDD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "jpyc-jpyc", symbol: "JPYC",
  ...
  {
    chain: ETHEREUM, stablecoinId: "xaum-matrixdock", symbol: "XAUm",
  ...
  {
    chain: ETHEREUM, stablecoinId: "eurr-stablr", symbol: "EURR",
  ...
  {
    chain: ETHEREUM, stablecoinId: "europ-schuman", symbol: "EUROP",
  ...
  {
    chain: ETHEREUM, stablecoinId: "deuro-deuro", symbol: "DEURO",
  ...
  {
    chain: ETHEREUM, stablecoinId: "tgbp-tokenised", symbol: "tGBP",
  ...
  {
    chain: ETHEREUM, stablecoinId: "syrupusdc-maple", symbol: "syrupUSDC",
  ...
  {
    chain: ETHEREUM, stablecoinId: "syrupusdt-maple", symbol: "syrupUSDT",
  ...
  {
    chain: ETHEREUM, stablecoinId: "aid-gaib", symbol: "AID",
  ...
  {
    chain: ETHEREUM, stablecoinId: "apxusd-apyx", symbol: "apxUSD",
  ...
  {
    chain: ETHEREUM, stablecoinId: "reusd-re-protocol", symbol: "reUSD",
