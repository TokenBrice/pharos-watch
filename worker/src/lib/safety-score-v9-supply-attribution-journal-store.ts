...
export const SUPPLY_ATTRIBUTION_JOURNAL_STORE_MAX_BATCH_RECORDS = 48;
export const SUPPLY_ATTRIBUTION_JOURNAL_STORE_MAX_BATCH_BYTES = 64 * 1_024;
export const SUPPLY_ATTRIBUTION_JOURNAL_STORE_MAX_RECORD_BYTES = 1_280;
