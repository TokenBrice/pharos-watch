...
export const PRICING_SOURCE_TO_CIRCUIT: Record<string, string | null> = {
  ...
  "meteora-dex": CIRCUIT_SOURCE.METEORA_API,
  "pancakeswap-dex": CIRCUIT_SOURCE.PANCAKESWAP_API,
  "aerodrome-dex": CIRCUIT_SOURCE.AERODROME_SLIPSTREAM_API,
  "velodrome-dex": CIRCUIT_SOURCE.VELODROME_SLIPSTREAM_API,
