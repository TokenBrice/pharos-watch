...
const D1_TABLE_GROWTH_TIMESTAMP_COLUMNS: Record<string, string> = {
  ...
  depeg_resolver_publication_snapshot_refs: "published_at",
  depeg_resolver_publication_snapshots: "published_at",
  depeg_resolver_publication_snapshots_v2: "published_at",
