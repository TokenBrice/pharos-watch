...
describe("buildYieldSyncMetadata", () => {
  it("writes bounded envelope rejections and comparison-anchor freshness under sourceCoverage", () => {
    ...
    const metadata = JSON.parse(buildYieldSyncMetadata({
      ...
      onChainRatesConfigured: 1,
      onChainEnvelopeRejections: envelopeRejections,
      onChainAttempted: 1,
      onChainAllDeterministicFailed: false,
      onChainExplorerAttempted: 0,
      onChainExplorerResolved: 0,
      onChainFailureMaskedByAlternativeCoverage: false,
      onChainAlternativeCoverageMissingIds: [],
      onChainFailures: null,
      onChainSkippedDueToCooldown: false,
      onChainCooldownActive: false,
      onChainCooldownTriggered: false,
      onChainCooldownUntil: null,
      onChainCooldownRemainingSec: 0,
      onChainConsecutiveAllFailRuns: 0,
      onChainConsecutiveMaskedAllFailRuns: 0,
      fallbackMode: null,
