#!/usr/bin/env npx tsx
/**
 * One-off data fix: candidate for deletion once the non-USD FX backfill correction is verified safe to drop.
 *
 ...
 *
 * Usage:
 *   cd worker && npx tsx ../scripts/oneshots/fix-non-usd-depeg-fx.ts          # dry-run
 *   cd worker && npx tsx ../scripts/oneshots/fix-non-usd-depeg-fx.ts --apply  # live mutation
 */
