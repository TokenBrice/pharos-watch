#!/usr/bin/env npx tsx
/**
 * One-off data fix: candidate for deletion once the commodity backfill correction is verified safe to drop.
 *
 ...
 *
 * Usage:
 *   cd worker && npx tsx ../scripts/oneshots/fix-commodity-depeg-median.ts          # dry-run
 *   cd worker && npx tsx ../scripts/oneshots/fix-commodity-depeg-median.ts --apply  # live mutation
 */
