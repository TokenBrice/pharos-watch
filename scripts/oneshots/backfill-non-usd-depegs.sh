#!/usr/bin/env bash
# One-off backfill: candidate for deletion once the non-USD FX backfill is verified safe to drop.
#
...
#
# Usage:
#   OPS_API_SERVICE_TOKEN_ID=… OPS_API_SERVICE_TOKEN_SECRET=… ./scripts/oneshots/backfill-non-usd-depegs.sh
#
# Optional:
