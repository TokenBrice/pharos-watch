...
export const CRITICAL_FILES = [
  ...
  // CLI-only calibration judge (worker/scripts/, outside the deployed bundle),
  // kept under the critical-coverage gate because it rules release anchors.
  "worker/scripts/lib/safety-score-v9-anchor-gate.ts",
  ...
  "worker/src/lib/safety-score-v9-curated-single-route-supply.ts",
  ...
  "worker/src/lib/telegram-pending-capacity.ts",
  ...
  "worker/src/lib/telegram-pending-queue.ts",
  ...
  "worker/src/lib/blacklist-summary-service.ts",
