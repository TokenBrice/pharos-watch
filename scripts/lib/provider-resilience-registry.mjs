...
export const PROVIDER_RESILIENCE_REGISTRY = [
  ...
  {
    id: "rpc-provider-parity-trial",
    family: "evm-rpc",
    description: "Hourly Dwellir provider-parity observation lane for the in-situ RPC trial.",
    files: [
      "worker/src/cron/rpc-provider-parity/index.ts",
      "worker/src/cron/rpc-provider-parity/probe.ts",
      "worker/src/lib/rpc-provider-parity/store.ts",
      "worker/src/lib/rpc-provider-parity/report.ts",
      "worker/src/lib/rpc-provider-parity/targets.ts",
      "worker/src/lib/rpc-provider-parity/types.ts",
    ],
    tests: [
      "worker/src/cron/rpc-provider-parity/__tests__/index.test.ts",
      "worker/src/cron/rpc-provider-parity/__tests__/probe.test.ts",
      "worker/src/lib/rpc-provider-parity/__tests__/report.test.ts",
      "worker/src/lib/rpc-provider-parity/__tests__/store.test.ts",
      "worker/src/lib/rpc-provider-parity/__tests__/targets.test.ts",
    ],
    allowBareFetch: false,
    resilience: {
      transport: "fetchTextWithRetry through the central fetch-retry policy, one request in flight",
      timeout: "RPC_PARITY_REQUEST_TIMEOUT_MS per request inside an RPC_PARITY_RUN_BUDGET_MS run deadline and the scheduled job signal.",
      body: "The central policy consumes or cancels every response body before the next serial request opens.",
      circuitSources: ["dwellir-evm"],
    },
    requiredMarkers: [
      "fetchTextWithRetry",
      "RPC_PARITY_REQUEST_TIMEOUT_MS",
      "RPC_PARITY_RUN_BUDGET_MS",
