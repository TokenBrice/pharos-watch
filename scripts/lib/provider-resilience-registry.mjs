...
export const PROVIDER_RESILIENCE_REGISTRY = [
  ...
  },
  {
    ...
    resilience: {
      ...
      circuitSources: ["telegram_transport_circuit", "CIRCUIT_SOURCE.TELEGRAM_API"],
    },
    requiredMarkers: [
      "AbortSignal.timeout",
      "drainResponseBody",
  ...
  },
  {
    ...
    resilience: {
      ...
      body: "Cancels non-OK bodies and parses JSON payloads.",
      circuitSources: [],
    },
  ...
  },
  {
    ...
    resilience: {
      transport: "direct-fetch",
      timeout: "Uses AbortSignal.timeout().",
      body: "Cancels non-OK bodies and validates parsed analytics shapes.",
      circuitSources: [],
    },
    requiredMarkers: ["AbortSignal.timeout", "cancelResponseBodyQuietly", "D1UsagePayloadError"],
  },
];
