...
export const PROVIDER_RESILIENCE_REGISTRY = [
  ...
  },
  {
    ...
    resilience: {
      ...
      body: "Cancels failed or unparsable response bodies.",
  ...
  },
  {
    ...
    resilience: {
      transport: "fetchWithRetry",
      timeout: "Uses fetchWithRetry default timeout plus cron AbortSignal.",
      body: "Cancels failed protocol response bodies.",
  ...
  },
  {
    ...
    resilience: {
      ...
      body: "Cancels non-OK bodies and parses JSON/text through shared helpers.",
  ...
  },
  {
    ...
    resilience: {
      transport: "direct-fetch",
      timeout: "Uses buildDirectApiRequestSignal().",
      body: "Cancels non-OK bodies and parses through readDexApiJson().",
      circuitSources: [
