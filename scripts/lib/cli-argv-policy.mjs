...
export const CLI_ARGV_POLICY = Object.freeze({
  ...
  exemptions: Object.freeze([
    ...
    exempt("scripts/maintenance/generate-agents-doc.mjs", "build"),
    ...
    exempt("scripts/maintenance/run-all-tests.mjs", "test"),
    exempt("scripts/maintenance/run-coverage-audit.mjs", "read-only"),
    ...
    exempt("scripts/maintenance/run-pr-checks.mjs", "test"),
    exempt("scripts/maintenance/run-pr-static-checks.mjs", "test"),
    exempt("scripts/maintenance/run-pr-tests.mjs", "test"),
