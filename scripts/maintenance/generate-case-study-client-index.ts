...
const OUTPUT = join(
  __dirname,
  "../../src/app/learn/case-studies/content/client-index.ts",
);
...
syncGeneratedArtifacts({
  ...
  check: CHECK_MODE,
  staleMessage:
    "src/app/learn/case-studies/content/client-index.ts is out of date. Run `tsx scripts/maintenance/generate-case-study-client-index.ts`.",
