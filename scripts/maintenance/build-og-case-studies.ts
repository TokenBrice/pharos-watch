    ...
    buildRenderInput: (card) => {
      ...
      return {
        ...
        signature: {
          ...
          logo: logoSignature,
          svgSha256: contentSha256(signatureSvg),
        },
      };
    },
