 ...
 *
 * Usage:
 *   node scripts/maintenance/generate-api-reference.mjs           # write
 *   node scripts/maintenance/generate-api-reference.mjs --check   # CI: exit 1 if stale
 */
...
function main() {
  ...
  if (CHECK_MODE) {
    if (next !== existing) {
      console.error(
        "docs/api-reference.md is out of date. Run `node scripts/maintenance/generate-api-reference.mjs`."
      );
      process.exit(1);
    }
