...
const MODULE_ALLOWLIST = new Set([
  ...
  // Legacy dead shim: runtime path migrated to a newer adapter composition.
  "shared/lib/pricing-source-adapter.ts",
]);
const EXPORT_ALLOWLIST = new Set([
  ...
  "shared/data/stablecoins/coins.frozen.generated.ts::STABLECOIN_META_ASSETS_FROZEN_COUNT",
