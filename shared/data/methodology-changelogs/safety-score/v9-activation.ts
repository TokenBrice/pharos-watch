...
export const SAFETY_SCORE_V9_MERGED_MINT_GRADER: MethodologyChangelogEntry = {
  ...
  impact: [
    ...
    "The curated `authorityPosture` field no longer scores: V9's derived posture is canonical and a curated-vs-derived disagreement raises a curation-queue item instead",
