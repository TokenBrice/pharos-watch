...
export const YIELD_METHODOLOGY_V8: readonly MethodologyChangelogEntry[] = [
  {
    ...
    summary:
      "PYS source risk replaces the hand-set 3-bucket venue tier with Yearn's shipped 5-category weighted rubric, scores 29 previously-unreviewed long-tail venues (12 → 41), adds a reviewer-set cross-venue dependency-concentration sub-signal, and anchors calibration to Yearn's own published yvUSDC risk report.",
    impact: [
