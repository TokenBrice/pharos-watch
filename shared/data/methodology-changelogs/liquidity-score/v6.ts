...
export const LIQUIDITY_SCORE_V6: readonly MethodologyChangelogEntry[] = [
  {
    ...
    impact: [
      ...
      "Reported DEX TVL for Raydium-exposed stablecoins decreases by the previously double-counted amount (typically 2-35% of a coin's measured TVL), and Liquidity Scores move accordingly — mostly down 1-5 points, slightly up where the venue-quality correction dominates. The old numbers overstated liquidity; no on-chain liquidity changed",
      "Because the Selector applies hard liquidity-score floors (50 for trading eligibility, 65 for the 1-hour exit-speed lane), coins near those floors may enter or leave Selector membership: USX, DUSD, and VCHF are expected to cross below the 50 floor. USDC stays comfortably above the 65 one-hour floor — a full replay of live source data through the corrected pipeline raises its score (about 68 to 76), because reclassifying roughly $1.9B of surviving concentrated Raydium rows to the correct venue-quality weight outweighs the roughly $330M of removed duplicate TVL",
