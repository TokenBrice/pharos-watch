...
export const SHADOW_STABLECOINS: StablecoinMeta[] = [
  ...
  { id: "3", llamaId: "3", detailProvider: "defillama", name: "TerraUSD", symbol: "UST", flags: { backing: "algorithmic", pegCurrency: "USD", governance: "decentralized", yieldBearing: false, rwa: false, navToken: false }, geckoId: "terrausd" },
  ...
  { id: "iron-finance", detailProvider: "coingecko", name: "IRON", symbol: "IRON", flags: { backing: "algorithmic", pegCurrency: "USD", governance: "decentralized", yieldBearing: false, rwa: false, navToken: false }, geckoId: "iron-stablecoin" },
];
