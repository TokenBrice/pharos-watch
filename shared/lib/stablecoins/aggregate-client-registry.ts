...
export const CLIENT_CORE_AGGREGATE_ACTIVE_STABLECOINS: readonly StablecoinClientMeta[] =
...
export const CLIENT_ACTIVE_VARIANT_STABLECOINS: readonly StablecoinClientMeta[] = CLIENT_ACTIVE_STABLECOINS.filter(
...
export const CLIENT_ACTIVE_STABLE_VALUE_INVESTMENTS: readonly StablecoinClientMeta[] = CLIENT_ACTIVE_STABLECOINS.filter(
  (stablecoin) => stablecoin.listingClass === "stable-value-investment",
);

export const CLIENT_ACTIVE_STABLE_VALUE_INVESTMENT_IDS: ReadonlySet<string> = new Set(
