...
export function parseTelegramDispatchCronMetadata(value: unknown): TelegramDispatchCronMetadata | null {
  ...
  return {
    ...
    cappedAtLimit: readMetadataBoolean(record.cappedAtLimit),
    snapshotSeeded: readMetadataBoolean(record.snapshotSeeded),
    eventlessFastPath: readMetadataBoolean(record.eventlessFastPath),
    ...
    pendingRateLimited: readMetadataBoolean(record.pendingRateLimited),
    ...
    safetyAlertsSuppressed: readMetadataBoolean(record.safetyAlertsSuppressed),
    ...
    reserveAlertsSuppressed: readMetadataBoolean(record.reserveAlertsSuppressed),
    ...
    presetFailure: readMetadataBoolean(record.presetFailure),
    ...
    eventsDetected: eventsRecord
      ? {
          ...
          freeze: readMetadataNumber(eventsRecord.freeze),
