...
export const PRICING_SOURCE_REGISTRY_DEX_SEARCH = [
  definePricingSource(PRICING_SOURCE_PRESETS.softDex, {
    key: "jupiter-exact",
    label: "Jupiter reviewed direct-route quote",
    shortLabel: "Jupiter exact",
  ...
  definePricingSource(PRICING_SOURCE_PRESETS.softDex, {
    key: "mento-fpmm",
    label: "Mento guarded pool quote",
    shortLabel: "Mento",
    depegSourceFamily: "dex:mento",
    maxTrustedAgeSec: 5 * 60,
    defaultWeight: 1,
    isReplaySafe: false,
    freshnessKind: "upstream",
  ...
  definePricingSource(PRICING_SOURCE_PRESETS.softDex, {
    key: "mento-broker",
    label: "Mento guarded Broker quote",
    shortLabel: "Mento Broker",
    depegSourceFamily: "dex:mento",
    maxTrustedAgeSec: 5 * 60,
    defaultWeight: 1,
    isReplaySafe: false,
