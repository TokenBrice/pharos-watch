...
export const STEAKUSDC_STEAKHOUSE_STABLECOIN_REDEEM_CONFIG = defineStablecoinRedeemConfig({
  capacityModel: { kind: "reserve-sync-metadata", fallbackRatio: 0.05, basis: "strategy-buffer" },
  executionModel: "rules-based-nav",
  costModel: fixedFee(
    0,
    "Steakhouse Prime Instant uses Morpho vaults; withdrawals redeem to USDC when liquidity is available and Morpho vault fees accrue from generated yield rather than a separate withdrawal fee.",
  ),
