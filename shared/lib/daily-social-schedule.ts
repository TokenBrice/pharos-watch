export const DAILY_SOCIAL_TIME_ZONE = "Europe/Belgrade";
export const DAILY_SOCIAL_PREPARATION_LEAD_SEC = 3600;
export const DAILY_SOCIAL_DELIVERY_WINDOW_SEC = 3600;
