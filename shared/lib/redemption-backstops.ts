...
> = {
  ...
  // --- Commodity-redeem (physical gold/silver) ---
  "paxg-paxos": {
    version: 1,
    routeFamily: "offchain-issuer",
    accessModel: "issuer-api",
  ...
  "cgo-comtech": {
    ...
    capacityModel: { kind: "supply-full" },
    costModel: documentedVariableFee(
      "Physical gold coins via ComTech Gold app; minimum 10 grams in 1-gram multiples",
    ),
  },
  "dgld-gold-token-sa": {
    version: 1,
    ...
    costModel: fixedFee(
      0,
      "No custody or transfer fees per Gold Token SA; minimum 1 gram",
    ),
  },
  "pgold-pleasing": {
    version: 1,
    ...
    capacityModel: { kind: "supply-full" },
    costModel: documentedVariableFee(
      "Physical gold via Pleasing platform; subject to KYC and size requirements",
    ),
  },
  // --- AMM / reserve-pool redemptions ---
  "cusd-celo": {
    version: 1,
    routeFamily: "collateral-redeem",
    accessModel: "permissionless-onchain",
    ...
    executionModel: "deterministic-onchain",
    outputAssetType: "mixed-collateral",
    capacityModel: { kind: "supply-ratio", ratio: 0.50 },
    costModel: documentedVariableFee(
  ...
  "gyd-gyroscope": {
    ...
    capacityModel: { kind: "supply-full" },
    costModel: documentedVariableFee(
      "Primary-market AMM (PAMM) adjusts redemption prices based on reserve ratio",
    ),
  },
  "usdp-parallel": {
    version: 1,
  ...
  // --- On-chain stablecoin-redeem (remaining) ---
  "usn-noon": {
    version: 1,
    routeFamily: "stablecoin-redeem",
    accessModel: "permissionless-onchain",
