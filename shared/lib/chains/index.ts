...
export const CHAIN_META: Record<string, ChainMeta> = {
  ...
  robinhood: { name: "Robinhood Chain", explorerUrl: "https://robinhoodchain.blockscout.com", evmChainId: 4663, type: "evm", logoPath: "/chains/robinhood.png", providers: { coingecko: "robinhood", dexscreener: "robinhood", geckoTerminal: "robinhood" } },
