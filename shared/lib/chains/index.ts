...
export const CHAIN_META: Record<string, ChainMeta> = {
  ...
  zksync:    { name: "zkSync",    explorerUrl: "https://explorer.zksync.io",       evmChainId: 324,   type: "evm",  logoPath: "/chains/zksync.png",    providers: { coingecko: "zksync", dexscreener: "zksync", geckoTerminal: "zksync", dexpaprika: "zksync", birdeye: "zksync" } },
  sonic:     { name: "Sonic",     explorerUrl: "https://sonicscan.org",            evmChainId: 146,   type: "evm",  logoPath: "/chains/sonic.png",     providers: { coingecko: "sonic", dexscreener: "sonic", geckoTerminal: "sonic" } },
  sei:       { name: "Sei",       explorerUrl: "https://seitrace.com",             evmChainId: 1329,  type: "evm",  logoPath: "/chains/sei.png",       providers: { coingecko: "sei-network", dexscreener: "sei", geckoTerminal: "sei-network", moralis: "sei" } },
  worldchain:{ name: "World Chain",explorerUrl: "https://worldscan.org",           evmChainId: 480,   type: "evm",  logoPath: "/chains/worldchain.png",providers: { coingecko: "world-chain", dexscreener: "worldchain", geckoTerminal: "world-chain" } },
  unichain:  { name: "Unichain",  explorerUrl: "https://uniscan.xyz",             evmChainId: 130,   type: "evm",  logoPath: "/chains/unichain.png",  providers: { coingecko: "unichain", dexscreener: "unichain", geckoTerminal: "unichain" } },
  ...
  plume:     { name: "Plume",     explorerUrl: "https://explorer.plumenetwork.xyz",evmChainId: 98866, type: "evm",  logoPath: "/chains/plume.png",     providers: { coingecko: "plume-network", dexscreener: "plume", geckoTerminal: "plume-network" } },
  hyperevm:       { name: "HyperEVM",       explorerUrl: "https://purrsec.com",                    evmChainId: 999,   type: "evm",   logoPath: "/chains/hyperevm.png",      providers: { coingecko: "hyperevm", dexscreener: "hyperevm", geckoTerminal: "hyperevm", birdeye: "hyperevm" } },
  ...
  megaeth:   { name: "MegaETH",   explorerUrl: "https://mega.etherscan.io",         evmChainId: 4326,  type: "evm",  logoPath: "/chains/megaeth.png", darkInvert: true, providers: { coingecko: "megaeth", dexscreener: "megaeth", geckoTerminal: "megaeth", birdeye: "megaeth" } },
  monad:     { name: "Monad",     explorerUrl: "https://explorer.monad.xyz",       evmChainId: 143,   type: "evm",  logoPath: "/chains/monad.png",     providers: { coingecko: "monad", dexscreener: "monad", geckoTerminal: "monad", moralis: "monad", birdeye: "monad" } },
  ...
  mantle:    { name: "Mantle",    explorerUrl: "https://mantlescan.xyz",           evmChainId: 5000,  type: "evm",  logoPath: "/chains/mantle.png",    providers: { coingecko: "mantle", dexscreener: "mantle", geckoTerminal: "mantle", birdeye: "mantle" } },
  linea:     { name: "Linea",    explorerUrl: "https://lineascan.build",           evmChainId: 59144, type: "evm",  logoPath: "/chains/linea.png",     providers: { coingecko: "linea", dexscreener: "linea", geckoTerminal: "linea", moralis: "linea", dexpaprika: "linea" } },
  scroll:    { name: "Scroll",   explorerUrl: "https://scrollscan.com",            evmChainId: 534352,type: "evm",  logoPath: "/chains/scroll.png",    providers: { coingecko: "scroll", dexscreener: "scroll", geckoTerminal: "scroll", dexpaprika: "scroll" } },
  blast:     { name: "Blast",    explorerUrl: "https://blastscan.io",              evmChainId: 81457, type: "evm",  logoPath: "/chains/blast.png",     providers: { coingecko: "blast", dexscreener: "blast", geckoTerminal: "blast" } },
  mode:      { name: "Mode",     explorerUrl: "https://modescan.io",              evmChainId: 34443, type: "evm",  logoPath: "/chains/mode.png",      providers: { coingecko: "mode", dexscreener: "mode", geckoTerminal: "mode" } },
  manta:     { name: "Manta",    explorerUrl: "https://pacific-explorer.manta.network", evmChainId: 169, type: "evm", logoPath: "/chains/manta.png",   providers: { coingecko: "manta-pacific", dexscreener: "manta", geckoTerminal: "manta-pacific" } },
  ...
  bob:       { name: "BOB",     explorerUrl: "https://explorer.gobob.xyz",        evmChainId: 60808, type: "evm",  logoPath: "/chains/bob.png",       providers: { coingecko: "bob-network", dexscreener: "bob", geckoTerminal: "bob-network" } },
  fraxtal:   { name: "Fraxtal", explorerUrl: "https://fraxscan.com",             evmChainId: 252,   type: "evm",  logoPath: "/chains/fraxtal.png"   },
  taiko:     { name: "Taiko",   explorerUrl: "https://taikoscan.io",             evmChainId: 167000,type: "evm",  logoPath: "/chains/taiko.png",     providers: { coingecko: "taiko", dexscreener: "taiko", geckoTerminal: "taiko" } },
  ...
  plasma:    { name: "Plasma",  explorerUrl: "https://plasma-explorer.com",       evmChainId: 9745,  type: "evm",  logoPath: "/chains/plasma.png",    providers: { coingecko: "plasma", dexscreener: "plasma", geckoTerminal: "plasma" } },
