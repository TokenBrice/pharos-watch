...
export const DEPEG_DEWS_METHODOLOGY_VERSION = "6.098";
...
export const LIQUIDITY_METHODOLOGY_VERSION = "5.94";
...
export const PRICING_PIPELINE_METHODOLOGY_VERSION = "6.205";
...
export const REDEMPTION_BACKSTOP_METHODOLOGY_VERSION = "4.20";
...
export const PSI_METHODOLOGY_VERSION = "3.6";
