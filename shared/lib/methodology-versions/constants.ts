...
export const DEPEG_DEWS_METHODOLOGY_VERSION = "6.26";
...
export const LIQUIDITY_METHODOLOGY_VERSION = "6.8";
...
export const MINT_BURN_FLOW_METHODOLOGY_VERSION = "6.2";
...
export const PRICING_PIPELINE_METHODOLOGY_VERSION = "6.33";
