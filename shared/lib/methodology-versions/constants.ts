...
export const DDR_METHODOLOGY_VERSION = "4.3";
...
export const MINT_BURN_FLOW_METHODOLOGY_VERSION = "6.191";
...
export const PRICING_PIPELINE_METHODOLOGY_VERSION = "6.208";
...
export const REDEMPTION_BACKSTOP_METHODOLOGY_VERSION = "4.38";
