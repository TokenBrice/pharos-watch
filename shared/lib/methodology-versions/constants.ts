...
export const LIQUIDITY_METHODOLOGY_VERSION = "5.98";
...
export const PRICING_PIPELINE_METHODOLOGY_VERSION = "6.207";
...
export const REDEMPTION_BACKSTOP_METHODOLOGY_VERSION = "4.21";
