...
Public-facing analytics dashboard tracking 186 stablecoins in repo metadata: 176 active assets on public data surfaces, 10 pre-launch entries, plus 2 shadow assets used only for PSI history. Pure information site — no wallet connectivity, no user accounts.
