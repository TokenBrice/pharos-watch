...
Public-facing analytics dashboard tracking 184 stablecoins in repo metadata: 175 active assets on public data surfaces, 9 pre-launch entries, plus 2 shadow assets used only for PSI history. Pure information site — no wallet connectivity, no user accounts.
