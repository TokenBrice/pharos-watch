...
Public-facing analytics dashboard tracking 391 stablecoins in repo metadata: 362 active assets on public data surfaces, 25 pre-launch entries, 4 frozen archives (preserved historical records only), plus 2 shadow assets used only for PSI history. Pure information site — no wallet connectivity, no user accounts.
