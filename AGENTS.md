...
- **`docs/worker-infrastructure.md`** — Env interface, cron scheduling (4 triggers, 20 named runtime jobs), edge cache, CORS, admin auth, alert system, undocumented cron details (charts, USDS, bluechip)
