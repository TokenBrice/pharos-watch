...
4. Add regression coverage for the secondary and tertiary live fallback paths.
5. Update pricing methodology/docs and the About page to reflect the wider externally visible FX fallback stack.
6. Validate locally, then push/deploy and watch live telemetry until two successful runs are observed.
