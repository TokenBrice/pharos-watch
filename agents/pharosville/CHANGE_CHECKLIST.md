...
- Read `docs/pharosville-page.md`, `agents/pharosville/CURRENT.md`, and `agents/pharosville/TESTING.md`.
- For asset work, also read `agents/pharosville/ASSET_PIPELINE.md`.
