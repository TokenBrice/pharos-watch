...
## Docs-Only Agent Changes

For changes limited to `agents/pharosville/`, `docs/agent-task-router.md`, `docs/doc-ownership.json`, or `docs/testing.md`, run:
...
If only `agents/pharosville/` changed and verified docs are untouched, these checks may not cover the agent archive. Still run them when the route/testing docs changed.
