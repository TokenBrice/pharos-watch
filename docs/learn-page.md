...
- **Case-study content registry:** `src/lib/case-studies/index.ts`
- **Case-study client index:** `src/lib/case-study-client-index.ts` generated by `scripts/maintenance/generate-case-study-client-index.ts`
- **Case-study schema:** `src/lib/case-studies/types.ts`
- **Glossary route:** `src/app/learn/glossary/page.tsx`
- **Glossary content/schema:** `src/lib/glossary-content.ts`
...
Glossary entries live in `src/lib/glossary-content.ts`. Each entry owns:
