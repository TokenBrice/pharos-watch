...
| Exact-address augmentation providers | 1 | `worker/src/lib/address-price-providers/index.ts` | Targeted DexScreener, DexPaprika, CoinGecko Onchain, Alchemy Prices, Moralis, and Solana Birdeye quotes for assets with missing prices or previous source depth below 3 |
