...
| `telegram_legacy_overflow_state` | Terminal singleton audit of the removed cache backlog importer; no longer read or written | absent/importing/imported/corrupt/oversized/degraded state, blob digest/size/count, synthetic source id, cursor, imported targets, error/timestamps |
