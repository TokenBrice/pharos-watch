...
- **Recomputation**: `computeStressedGrades()` injects a synthetic score, recomputes only the Dependency Risk dimension for affected downstream coins. ~229 cards (151 tracked + 78 cemetery) × 5 dimensions = <1ms, no debouncing needed.
