...
- **Recomputation**: `computeStressedGrades()` injects a synthetic score, recomputes only the Dependency Risk dimension for affected downstream coins. ~226 cards (148 tracked + 78 cemetery) × 5 dimensions = <1ms, no debouncing needed.
