...
- **Canonical source:** `shared/lib/stability-index-version.ts` (re-exported from `shared/lib/methodology-versions/stability-index.ts`, with changelog entries in `shared/data/methodology-changelogs/stability-index/`)
