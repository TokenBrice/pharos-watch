...
- **Current methodology version:** `v1.10`
...
- **Route families:** 77 `offchain-issuer`, 18 `stablecoin-redeem`, 18 `collateral-redeem`, 12 `queue-redeem`, 9 `psm-swap`, 3 `basket-redeem`
