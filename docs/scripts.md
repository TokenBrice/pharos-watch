...
| `scripts/check-shared-cycles.mjs`               | Detect circular dependencies inside `shared/` so shared runtime-neutral modules do not regress into import cycles                                                         | `shared/**`, local `tsconfig.json`, `madge`                                                                                                                                                                                                                                                                | Exits non-zero when `shared/` contains a circular dependency                                                             |
...
| `scripts/check-hotspot-ratchet.mjs`             | Prevent the tracked hotspot shells/body modules from growing beyond the checked-in post-refactor baseline                                                                 | `scripts/lib/hotspot-ratchet-baseline.json`, `scripts/lib/hotspot-ratchet.mjs`, and the current tracked hotspot target list                                                                                                                                                                               | Exits non-zero when file size / largest function / branch-count regressions occur                                        |
