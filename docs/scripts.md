...
| `scripts/test-merge-gate.mjs`                   | Local merge gate that mirrors the shared CI validate core and adds build/SEO only when export-critical files changed                                                      | Local git diff + npm scripts                                                                                                                                                                                                                                                                               | Runs the CI validate core locally, plus conditional `build`/`seo:check`                                                  |
