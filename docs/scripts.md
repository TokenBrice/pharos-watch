...
| `scripts/check-unused-code.mjs`                 | Detect unreferenced internal runtime modules and unused named exports in hotspot runtime areas                                                      | Runtime source graph across `src`, `shared`, `worker/src`, and `functions`                                                                                                                                                                                                                                 | Exits non-zero with dead-module / unused-export findings                                                        |
| `scripts/check-hotspot-ratchet.mjs`             | Prevent key hotspot files from growing beyond the checked-in post-refactor baseline                                                                 | `scripts/lib/hotspot-ratchet-baseline.json`, targeted runtime files                                                                                                                                                                                                                                        | Exits non-zero when file size / largest function / branch-count regressions occur                               |
