...
| `scripts/check-sql-interpolation-safety.mjs`    | Detect unsafe SQL template-literal interpolation in worker source (table names must be validated or allowlisted, not dynamically injected)                               | `worker/src/**/*.ts` (excluding tests and mocks)                                                                                                                                                                                                                                                           | Exits non-zero on unguarded dynamic SQL table-name interpolation                                                         |
