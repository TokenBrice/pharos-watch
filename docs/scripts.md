...
| `scripts/check-hotspot-ratchet.mjs`             | Prevent the tracked hotspot files from growing beyond the checked-in post-refactor baseline                                                                               | `scripts/lib/hotspot-ratchet-baseline.json`, currently the seventeen ratcheted hotspot files                                                                                                                                                                                                               | Exits non-zero when file size / largest function / branch-count regressions occur                                        |
...
| `scripts/check-doc-sync.ts`                     | Detect stale exact methodology versions, metric weights, thresholds, and enforced limits in high-risk docs                                                                | Canonical version modules in `shared/lib/*-version.ts`, metric source files in `shared/lib/**` and `worker/src/**`, scoped doc files in `docs/`                                                                                                                                                            | Exits non-zero listing files with stale exact-value documentation                                                        |
