...
- ... 374 more files omitted; use `rg --files src/components` for the full list.
...
- ... 227 more files omitted; use `rg --files worker/src/lib` for the full list.
...
- ... 194 more files omitted; use `rg --files scripts` for the full list.
