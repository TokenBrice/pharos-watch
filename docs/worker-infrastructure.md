...
| `cron-staleness-watchdog:alert:direct:v1`                  | `runCronStalenessWatchdog`       | Successful consolidated operator-alert delivery timestamp used for the 30-minute flap cooldown                                                                                                                                                                                                                           |
