...
- CoinGecko Onchain pool discovery treats malformed pool members as schema-degraded: valid siblings still stage, and an all-invalid response cannot verify that a deployment has no pools. Breaker accounting remains transport-based for these responses.
