...
| `dex-exit-route-turnover-watchdog:snapshot:v1`             | `cron-sentinel` turnover source | Compact previous DEX publication generation and per-coin `routeId -> evidenceKind` sets used to detect substantial published-route turnover across missed producer cycles                                                                                                                                                |
