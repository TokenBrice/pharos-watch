...
- The pricing roster includes guarded CHFm FPMM and CADm/COPm Broker sell quotes from Mento; USDm parent pricing and executable pool-state checks are required, without assumed FX parity.
