...
- Reserve-transparency sources now include issuer/protocol reserve APIs, dashboards, and direct on-chain vault/accounting reads used for live reserve composition where available, with current examples including infiniFi, M0, OpenEden, and Accountable feeds.
