...
- `src/app/pharoswatchbot/app/page.test.tsx` — client preview/post-launch rendering, server-confirmed mutation timing, stale-refresh recovery, suggestion navigation, and timezone selection.
