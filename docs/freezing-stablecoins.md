...
- **Methodology versions unchanged.** Per-domain methodology version constants (Safety Scores 7.18, Liquidity 5.5, Depeg/DEWS 5.96, PSI 3.2, Yield 7.44, Mint/Burn 6.0, Pricing 5.02, Blacklist 3.99, Redemption Backstop 3.994, Chain Health 1.2) are NOT bumped on freeze. Frozen status is a lifecycle policy, not a scoring change.
