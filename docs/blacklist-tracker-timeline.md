...
- **Primary navigation** — `FreezeWatch` becomes the 7th `PRIMARY_NAV_ITEMS` entry (between Non-USD Stables and PharosWatchBot), with a custom hexagonal FreezeShield icon
