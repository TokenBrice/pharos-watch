...
| standard           | `public, s-maxage=300, max-age=60`                             | stablecoin-charts, depeg-resolver, depeg-resolver-review, redemption-backstops, usds-status, daily-digest, digest-archive, report-cards, V9 feedback preview, stability-index, yield-rankings, yield-adapter-manifest, mint-burn-flows, stress-signals                                                                                                                                              |
...
| GET | `/api/report-cards/v9-preview` | Safety Score V9 feedback preview | Risk | X-API-Key | — | 200, 400, 401, 429, 503 |
| GET | `/api/report-cards/v9-preview-412d818c031b7bc5` | Safety Score V9 feedback preview (legacy alias) | Risk | X-API-Key | — | 200, 400, 401, 429, 503 |
