...
| `pysNullReason`                          | ranking rows                | `"apy-non-positive" \| "effective-yield-non-positive" \| "scaling-invalid" \| "missing-inputs" \| "source-stale" \| "benchmark-stale" \| null \| undefined` | Machine-readable reason an exact current PYS is unavailable; stale rows remain visible as NR context                                                                              |
