...
| `sync-live-reserves.test.ts`            | `sync-live-reserves.ts`            | Adapter orchestration, circuit-open skips, degraded warning handling, and source-invariant shared-result dedupe                                                 |
