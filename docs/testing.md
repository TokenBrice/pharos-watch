...
- Static export SEO: `npm run seo:check`; this includes built-anchor rejection for reviewed legacy aliases plus one-hop/permanent checks for internal `_redirects` rules. Live SEO smoke is `npm run seo:live-smoke -- --url https://pharos.watch`.
