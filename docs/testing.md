...
| `jwt-verify.test.ts`                  | `worker/src/lib/jwt-verify.ts`                             | JWT signature verification, expiry checks, and claim validation                                                                        |
...
| `mint-burn-parse.test.ts`             | `worker/src/lib/mint-burn-parse.ts`                        | Event log parsing, contract event decoding, and parameter extraction                                                                   |
| `mint-burn-roundtrip-sweep.test.ts`   | `worker/src/lib/mint-burn-roundtrip-sweep.ts`              | Roundtrip detection sweep, transaction pairing, and matching logic                                                                     |
...
| `psi-benchmark-scenarios.test.ts`     | `worker/src/lib/psi-benchmark-scenarios.ts`                | PSI benchmark scenarios for stablecoin stress patterns and regime changes                                                              |
...
| `report-cards-snapshot-topo.test.ts`  | `worker/src/lib/report-cards-snapshot-topo.ts`             | Report-card snapshot topology and dependency ordering for computation                                                                   |
...
| `stablecoins-cache-validation.test.ts`| `worker/src/lib/stablecoins-cache-validation.ts`           | Stablecoins cache structure validation and schema compliance                                                                            |
...
| `telegram-bot-stats.test.ts`          | `worker/src/lib/telegram-bot-stats.ts`                     | Telegram bot statistics, subscription metrics, and usage tracking                                                                       |
