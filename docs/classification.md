...
`USD`, `EUR`, `GBP`, `CHF`, `BRL`, `RUB`, `JPY`, `KRW`, `IDR`, `INR`, `MYR`, `SGD`, `HKD`, `TRY`, `AUD`, `ZAR`, `CAD`, `CNY`, `CNH`, `PHP`, `MXN`, `VND`, `UAH`, `ARS`, `KGS`, `NGN`, `GOLD`, `SILVER`, `VAR` (variable/CPI-linked), `OTHER`
