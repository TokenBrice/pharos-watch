...
Like the editorial generator, write mode promotes staged PNGs only when their pixels changed materially, avoiding transient Git changes from Firefox encoding drift during routine builds.
