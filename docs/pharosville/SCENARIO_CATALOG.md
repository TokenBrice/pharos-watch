...
| Authored geography | `systems/world-layout.test.ts` | Sea-first ratio, lighthouse headland, risk anchors, cemetery scatter, and civic placement invariants | `npm test -- src/app/pharosville/systems/world-layout.test.ts` |
