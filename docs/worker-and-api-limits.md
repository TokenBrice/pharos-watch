...
Source: `worker/src/lib/constants.ts` (timeout/retries), `worker/src/cron/digest/platform.ts` (model/thinking/effort), `worker/src/cron/daily-digest.ts` and `worker/src/cron/weekly-recap.ts` (max_tokens)
