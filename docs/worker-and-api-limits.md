...
| DexScreener address augmentation      | `1` request/run, `30` addresses/request                                      | `worker/src/lib/address-price-providers/dexscreener.ts` | Exact `/tokens/v1/{chain}/{addresses}` lane; no symbol search; stops on hard upstream refusal                     |
