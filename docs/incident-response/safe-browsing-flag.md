...
Add lessons learned to `docs/security-governance.md` under the appropriate Rule. Update `scripts/check-phishing-signatures.mjs` if a new signature was identified. If the trigger was something the CI guardrails didn't catch, add a check.
