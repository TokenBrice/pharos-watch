...
The panel and the rail `CollateralizationCard` are complementary, not duplicative: the rail carries the measured CDP ratio for the 81 CDP overlays, the panel carries the narrative and provenance for all reviewed archetypes — including fiat-cash and tbill, which carry no quantitative metrics at all.
