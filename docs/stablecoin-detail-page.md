...
7. Content grid (Figma coin template): single column below `xl`; at `xl+` an `xl:grid-cols-[minmax(0,1fr)_22rem]` grid places the summary rail beside the main column. The main column opens with the hero block (items 2–4) and then holds everything in items 8–16; the rail is item 17.
