...
<Link href="/blacklist" className="hover:text-foreground transition-colors">Freeze Tracker</Link>
          ...
          <div className="flex items-center gap-3 text-xs text-muted-foreground">
            ...
            <a href="https://github.com/TokenBrice/stablecoin-dashboard" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors" aria-label="Pharos on GitHub">
            ...
            <a href="https://t.me/pharoswatch" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors" aria-label="Pharos on Telegram">
