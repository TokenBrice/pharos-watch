...
export const TAPE_CLASSES: readonly TapeClassDef[] = [
  ...
  { slug: "dews",        label: "DEWS bands",   description: "Depeg Early Warning System band transitions.",           hasProjector: true  },
  { slug: "psi",         label: "PSI bands",    description: "Pharos Stability Index band shifts.",                    hasProjector: true  },
  { slug: "mint_burn",   label: "Mint/burn",    description: "Large single-transaction mint/burn flows.",              hasProjector: true  },
  ...
  { slug: "yield",       label: "Yield",        description: "Yield warning signals and PYS drops.",                   hasProjector: true  },
