...
export function ContagionGraphHeader({ graph, dependencyHubCount }: ContagionGraphHeaderProps) {
  const hubCount = dependencyHubCount ?? countVisibleHubs(graph);
      ...
      <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
        ...
        <div className="grid grid-cols-3 gap-2 sm:w-auto">
          ...
          <div className="rounded-md border border-border/70 bg-background/70 px-3 py-2">
            ...
            <p className="font-mono text-sm font-semibold tabular-nums text-foreground">{hubCount}</p>
          </div>
        </div>
      </div>
