        ...
        {modes.map((mode, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "pharos-focus-ring inline-flex min-h-11 min-w-[7.5rem] items-center justify-between gap-2 rounded-md border px-3 text-xs font-medium transition-colors motion-reduce:transition-none",
                active
