...
const TOP_FOLD_COPY_BY_STATUS: Record<StatusResponse["overallStatus"], TopFoldCopy> = {
  healthy: {
    ...
    shell: "border-emerald-500/24 bg-[linear-gradient(140deg,oklch(0.985_0.02_150_/_0.98),oklch(0.975_0.012_248_/_0.99))] shadow-[0_18px_48px_oklch(0_0_0_/_0.08)] dark:border-emerald-500/18 dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.92),rgba(2,6,23,0.98))] dark:shadow-[0_24px_60px_oklch(0_0_0_/_0.22)]",
  ...
  degraded: {
    ...
    shell: "border-amber-500/24 bg-[linear-gradient(140deg,oklch(0.985_0.02_85_/_0.98),oklch(0.975_0.012_248_/_0.99))] shadow-[0_18px_48px_oklch(0_0_0_/_0.08)] dark:border-amber-500/18 dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.92),rgba(2,6,23,0.98))] dark:shadow-[0_24px_60px_oklch(0_0_0_/_0.22)]",
  ...
  stale: {
    ...
    shell: "border-red-500/24 bg-[linear-gradient(140deg,oklch(0.985_0.02_25_/_0.98),oklch(0.975_0.012_248_/_0.99))] shadow-[0_18px_48px_oklch(0_0_0_/_0.08)] dark:border-red-500/18 dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.92),rgba(2,6,23,0.98))] dark:shadow-[0_24px_60px_oklch(0_0_0_/_0.22)]",
...
const RECOVERY_HOLD_COPY: Record<Exclude<StatusResponse["rawOverallStatus"], "stale">, TopFoldCopy> = {
  healthy: {
    ...
    shell: "border-amber-500/24 bg-[linear-gradient(140deg,oklch(0.985_0.02_85_/_0.98),oklch(0.975_0.012_25_/_0.99))] shadow-[0_18px_48px_oklch(0_0_0_/_0.08)] dark:border-amber-500/18 dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.92),rgba(2,6,23,0.98))] dark:shadow-[0_24px_60px_oklch(0_0_0_/_0.22)]",
    flareA: "bg-amber-400/14",
    flareB: "bg-red-300/10",
    ruler: "via-amber-300/55",
    kicker: "text-amber-300/85",
