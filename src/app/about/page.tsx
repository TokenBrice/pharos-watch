...
const DATA_SOURCE_GROUPS = [
  ...
  { label: "On-chain Events", sources: "Etherscan v2 (freeze events, mint/burn flows), TronGrid, Alchemy & dRPC (EVM RPCs)" },
  { label: "Ratings & Reference", sources: "Bluechip, ECB via Frankfurter, fawazahmed0/exchange-api, gold-api.com, U.S. Treasury Fiscal Data (T-bill rates)" },
