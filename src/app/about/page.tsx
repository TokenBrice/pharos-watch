...
const DATA_SOURCE_GROUPS = [
  ...
  },
  {
    ...
    sources:
      "Issuer and protocol reserve APIs, dashboards, proof-of-reserve portals, and direct on-chain vault/accounting reads (including live reserve composition feeds from providers such as Anzen, Ethena, Falcon, infiniFi, M0, Mento Reserve, OpenEden, Re, USDD, USD.AI, Accountable, Tether, Frax, Circle, First Digital Labs, SG-FORGE, Paxos, Sky/MakerDAO, Chainlink PoR/NAV oracles, Aave GHO, and Curve/Yield Basis reserve reads where available)",
  },
  {
    label: "On-chain Reads & Events",
    sources:
      "Sim by Dune wallet balances and DeFi positions, reviewed DefiLlama treasury adapters on GitHub, Etherscan v2 (freeze events), TronGrid, Alchemy, dRPC, selected public chain RPCs (EVM RPCs, including Ethereum mint/burn flows and direct Liquity/B.Protocol reads), and reconciled freeze-ledger bootstrap rows from kyc.rip / stables.rip for major ETH and TRON blacklist coverage",
  },
  {
  ...
  },
  {
    label: "DEX Data",
    sources:
      "DeFiLlama Yields & Protocols, protocol-native yield APIs (Hashnote, Ondo, Morpho, Pendle, Yearn Kong, Beefy, Aave V3, Compound V3, BIMA Earn), Curve Finance API, The Graph, Fluid API + DexReservesResolver, Balancer API, Raydium API, Orca API, Meteora API, PancakeSwap subgraphs, Aerodrome and Velodrome Sugar view contracts, GeckoTerminal, DexScreener",
  },
