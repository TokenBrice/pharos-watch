...
const DATA_SOURCE_GROUPS = [
  ...
  },
  {
    ...
    sources:
      "Bluechip, Chainlink Data Feeds, ECB via Frankfurter, Open Exchange Rates (real-time FX cross-validation), fawazahmed0/currency-api (CNH and non-ECB FX), ExchangeRate-API (tertiary full-set FX fallback), gold-api.com, FRED DGS3MO and ECBESTRVOLWGTTRMDMNRT (USD and EUR benchmark rates), and the SNB current-rates page (CHF policy-rate proxy)",
  },
  {
    label: "DEX Data",
