...
const DATA_SOURCE_GROUPS = [
  {
    label: "Supply & Price",
    sources: "DefiLlama, CoinGecko, CoinMarketCap, DexScreener, and direct protocol redemption quotes for selected redeemable assets",
  },
  {
