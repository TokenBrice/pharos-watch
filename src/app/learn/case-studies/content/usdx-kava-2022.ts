...
export const content: CaseStudy = {
  ...
  watchpoints: [
    "Collateral whitelists that accept other stablecoins — especially algorithmic or reflexively-backed ones — as backing, importing the worst-case behavior of an asset that can go to near-zero.",
  ...
  metaDescription:
    "Kava USDX broke peg in May 2022 because UST, a whitelisted collateral asset, collapsed — falling to ~$0.47 and never recovering. One bad leg was terminal.",
