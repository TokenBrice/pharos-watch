...
export const content: CaseStudy = {
  ...
  lead: [
    "On the weekend of March 10-13, 2023, USDC traded as low as roughly $0.87 — a peak deviation near 1,300 bps below par, the largest the issuer had ever recorded. The cause sat one layer below the token: about $3.3 billion of Circle's cash reserves were deposited at Silicon Valley Bank, which entered FDIC receivership on Friday, March 10.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "The lesson here is not that USDC was undercollateralized. It was that even an over-reserved, transparently attested stablecoin is only as liquid as the weakest link in its redemption path — and for a fiat-backed coin, that path runs through commercial banks that keep limited weekend hours and can themselves fail.",
