...
/**
 * 2025 — Synthetix passes SIP-420, replacing per-staker debt with a single
 ...
 * to an ~$0.21 all-time low in August 2025. A depeg caused by a governance vote,
 * not a hack or an insolvency. susd-synthetix already carries curated annotations
 * (SIP-420 + the ATL) — this study references them, it does not add new ones.
 */
export const content: CaseStudy = {
  ...
  crossLinks: [
    ...
    { href: "/stablecoin/susd-synthetix/", label: "sUSD live data and risk" },
    {
  ...
  metaDescription:
    "How Synthetix's SIP-420 governance vote depegged sUSD by pooling debt and killing the repeg incentive — a self-inflicted CDP failure, not a hack.",
