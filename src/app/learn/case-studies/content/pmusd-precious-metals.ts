...
export const content: CaseStudy = {
  ...
  lead: [
    ...
    "Pharos has recorded 354 distinct deviation events on pmUSD between February 15 and May 2, 2026, of which 337 are below par. The overwhelming majority of those are shallow but persistent: 336 below-peg excursions clustered between roughly 100 and 356 basis points under par, with a median around 174 bps and most readings in the 100-to-200 bps band. This is not the signature of a token that occasionally wobbles and snaps back; it is a token that has spent most of its tracked life trading at a visible discount, with only 17 brief excursions above par.",
