...
const LEAD_PARAGRAPH =
  "The Selector applies Pharos's per-profile exclusion filters and shows you the tracked stablecoins that survive, sorted by how well they fit the profile you describe. You give it a profile — Treasury, Yield, or Active Trading. It returns 3 candidates ranked under that profile's weights, plus 2 coins lower-ranked for the same use case. Every entry anchors to a live data point and links to the Screener for verification. This is filter output, not advice.";
