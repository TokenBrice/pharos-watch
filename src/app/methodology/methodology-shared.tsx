    ...
    >
      <CardHeader className="space-y-2">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className={`inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-mono font-semibold ${badgeClassName}`}>
            {versionLabel}
          </span>
          <Link
            href={changelogPath}
            className={`text-xs text-foreground underline underline-offset-4 transition-colors ${changelogClassName}`}
          >
