    ...
    <>
      ...
      <MethodologyDetails summary="Depeg Confirmation & Trust Gates">
        <div className="space-y-3">
          ...
          <p>
            Every onset waits beyond the full trigger threshold for at least 15 minutes, even when multiple sources already agree. Pending confirmation chooses off-chain confirmers by source family from the primary <code className="mx-1 text-xs">agreeSources</code> set. CoinGecko-family primary evidence cannot be confirmed by CoinGecko again, and Pharos does not treat DefiLlama&apos;s <code className="mx-1 text-xs">coingecko:&#123;id&#125;</code> mirror as independent. Promoted rows store canonical keys such as <code className="mx-1 text-xs">temporal:15m</code>, <code className="mx-1 text-xs">coingecko-confirm</code>, and <code className="mx-1 text-xs">dex:curve</code> for auditability.
          </p>
          <p>
