    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          Same-run live adapter telemetry can also carry token-specific route status for Liquity-style systems,
          wrappers, PSMs, and instant-redemption vaults. Redemption metadata emitted by a live reserve adapter ages out
          with the reserve snapshot; if it is stale or degraded, the route stays visible but does not score as current
          capacity.
        </p>
        <p>
