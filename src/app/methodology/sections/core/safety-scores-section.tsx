...
export function SafetyScoresMethodologySection() {
  return (
          ...
          >
              ...
              <MethodologyDetails summary="Interactive calculator: explore how weights and thresholds shape the grade"><SafetyScoreCalculator /></MethodologyDetails>
