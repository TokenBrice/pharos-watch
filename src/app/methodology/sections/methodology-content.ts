...
export const SAFETY_SCORES_SECTION_CONTENT = defineMethodologySectionContent({
  ...
  markdownParagraphs: [
    ...
    "Liquidity / Exit measures how much usable exit capacity exists across DEX depth and eligible redemption backstops. Resilience measures collateral quality and custody model. Chain tier, deployment model, reviewed CDP oracle setup, and Mint Authority affect the Decentralization penalties, and resolvable wrappers inherit Decentralization from their wrapped asset with a wrapper-kind haircut. Dependency Risk penalizes wrapper, collateral, and mechanism exposure to other assets, with tracked parent-linked variants applying family-specific wrapper ceilings.",
