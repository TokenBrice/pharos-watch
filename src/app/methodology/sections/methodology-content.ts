...
export const YIELD_SECTION_CONTENT = defineMethodologySectionContent({
  ...
  markdownParagraphs: [
    ...
    "Warnings explain why a venue is risky, missing, stale, or benchmark-adjusted so yield pages do not promote fragile opportunities as clean income. Source and benchmark freshness are eligibility rules: expired evidence remains visible as NR context but cannot carry an exact current PYS.",
  ],
});
