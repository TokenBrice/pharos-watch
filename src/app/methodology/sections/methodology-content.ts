...
export const DEPEG_RESOLVER_SECTION_CONTENT = defineMethodologySectionContent({
  ...
  markdownParagraphs: [
    ...
    "The Depeg Duration Resolver Reviewer (DDRR) scores frozen first-published predictions against later canonical depeg-event outcomes and reports coverage accountability for no-calls, pre-lock recoveries, missed locks, publication retries/failures, data-quality gaps, and invalidated rows. Recovery-likelihood accuracy and duration error use only scoreable public predictions.",
