          ...
          __html: safeJsonLd(buildFaqJsonLd([
            {
              ...
              answer: `Pharos computes a weighted average of five base dimensions — Liquidity (30%), Resilience (20%), Decentralization (15%), Dependency Risk (25%), and Peg Stability — then applies a peg stability power-curve multiplier. Redemption backstops can improve Liquidity only when the route is currently usable and the redemption snapshot is fresh; documented issuer exits add only a DEX-gated primary-market bonus, while severe active depegs use the open event peak for final caps and disable static or non-live-direct redemption uplift unless live-open redemption evidence exists. When liquidity data is absent, a 10% penalty is applied to the final score after the peg multiplier (weights are redistributed across available dimensions). Grades range from A+ (87+) to F (0–39), with NR for insufficient data. The methodology is currently at ${SAFETY_SCORE_VERSION_LABEL}.`,
            },
            {
            ...
            },
            {
              ...
              answer: "The liquidity score is a composite 0–100 metric combining TVL depth (30%), volume activity (20%), pool quality (20%), durability (20%), and pair diversity (10%). Volume uses log-scale scoring. Pool quality is adjusted for mechanism type and balance health; pair quality affects effective TVL depth.",
            },
            {
