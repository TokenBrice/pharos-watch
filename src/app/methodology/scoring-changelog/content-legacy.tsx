...
export function ScoringChangelogLegacyEntries() {
  return (
    <>
      {/* ──────────── v4 ──────────── */}
      <VersionCard entry={getScoringEntry("4.1")}>
        <p>
      ...
      <VersionCard entry={getScoringEntry("4.0")}>
        <p>
        ...
        <p>
          Grade thresholds lowered 5 points to compensate for structural deflation. Minimum rated base dimensions
          reduced from 3 to 2.
        </p>
      ...
      {/* ──────────── v3 ──────────── */}
      <VersionCard entry={getScoringEntry("3.3")}>
        <p>
      ...
      <VersionCard entry={getScoringEntry("3.2")}>
        <p>
      ...
      <VersionCard entry={getScoringEntry("3.0")}>
        <p>
      ...
      {/* ──────────── v2 ──────────── */}
      <VersionCard entry={getScoringEntry("2.0")}>
        <p>
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Decentralization widened: decentralized 95&rarr;100, centralized-dependent 70&rarr;50, centralized
              50&rarr;0
            </li>
      ...
      {/* ──────────── v1 ──────────── */}
      <VersionCard entry={getScoringEntry("1.0")}>
