...
import { ChangelogTable, VersionCard, WeightRow, changelogTableClassNames, getScoringEntry } from "./content-shared";

export function ScoringChangelogV5Entries() {
  return (
    <>
      {/* ──────────── v5.9 ──────────── */}
      <VersionCard entry={getScoringEntry("5.9")}>
        <p>
      ...
      {/* ──────────── v5.8 ──────────── */}
      <VersionCard entry={getScoringEntry("5.8")}>
        <p>
      ...
      {/* ──────────── v5.7 ──────────── */}
      <VersionCard entry={getScoringEntry("5.7")}>
        <p>
      ...
      {/* ──────────── v5.6 ──────────── */}
      <VersionCard entry={getScoringEntry("5.6")}>
        <p>
      ...
      {/* ──────────── v5.5 ──────────── */}
      <VersionCard entry={getScoringEntry("5.5")}>
        <p>
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            ...
            coin&apos;s earliest supply snapshot instead of always defaulting to a 4-year window. A 30-day-old coin is
            now scored over 30 days, not 1,461.
          </li>
          <li>
          ...
          <li>
            <span className="text-foreground font-medium">Active depeg penalty steepened</span> &mdash; floor raised
            from 2 to 5, divisor changed from 200 to 50. A 500&nbsp;bps ongoing depeg now costs 10 points (was 2.5).
          </li>
        </ul>
      </VersionCard>

      {/* ──────────── v5.4 ──────────── */}
      <VersionCard entry={getScoringEntry("5.4")}>
        <p>
      ...
      {/* ──────────── v5.3 ──────────── */}
      <VersionCard entry={getScoringEntry("5.3")}>
        <p>
      ...
      {/* ──────────── v5.2 ──────────── */}
      <VersionCard entry={getScoringEntry("5.2")}>
        <p>
      ...
      {/* ──────────── v5.1 ──────────── */}
      <VersionCard entry={getScoringEntry("5.1")}>
        <ul className="list-disc list-inside space-y-1">
          <li>
      ...
      {/* ──────────── v5.0 ──────────── */}
      <VersionCard entry={getScoringEntry("5.0")}>
        <div className="space-y-2">
