...
export const REDEMPTION_BACKSTOP_SECTION_CONTENT = defineMethodologySectionContent({
  ...
  markdownParagraphs: [
    ...
    "Since v4.39, a measured route scores zero when executable capacity is zero or below both the 1% completion and $100,000 absolute breakpoints; missing capacity remains unrated. Reviewed settlement overrides are shared by the standalone row and V9. Reserve-sync routes publish full-supply eventual capacity only when dated route evidence explicitly opts into that claim.",
