...
export const content: CaseStudy = {
  ...
  timeline: [
    ...
    },
    {
      ...
      body: "With the individual repeg arbitrage gone and minting cheaper, sUSD oversupplies and dominates its own liquidity venues, at points making up well over 75% of major Curve pairs. That is the on-chain signature of holders trying to exit a coin with no natural buyer of last resort. On-chain analysts attribute the depeg to the SIP-420 incentive change rather than to bad debt or any backing failure.",
      severity: "high",
    },
    {
      dateISO: "2025-08-31",
