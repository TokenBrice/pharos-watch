...
export const content: CaseStudy = {
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "That posture is exactly what made the SVB weekend a clean experiment. When the banking channel that USDC, Dai, and FRAX all depended on closed for the weekend, LUSD had no equivalent channel to lose. Its resilience was not a defense mounted under stress; it was the absence of the thing that was breaking everywhere else.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Immutability and patchability are mutually exclusive, and that is a choice with a price. LUSD's governance-free design is what makes it impossible to freeze or quietly rewrite — and what made the 2025 V2 issue a full redeploy rather than a hotfix. A resilient stablecoin is not one with no failure modes; it is one whose failure modes are visible, bounded, and accepted up front.",
      ],
    },
  ],
  dataWidgets: [
  ...
  watchpoints: [
    "Redemption-path dependencies versus collateral quality: a coin can be conservatively backed and still depeg if its redemption runs through a counterparty (a bank, a PSM, a single issuer) that can stall — the exposure Pharos maps in the dependency view.",
