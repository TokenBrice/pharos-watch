...
export const content: CaseStudy = {
  ...
  lead: [
    ...
    "On July 6, 2023, roughly $126–130M drained out of Multichain's Fantom, Moonriver, and Dogechain bridge contracts in a single burst of abnormal outflows, with nearly $120M of it leaving the Fantom bridge alone. The deposits that backed every wrapped asset on Fantom were simply gone. USDC.m, with nothing left behind it, repriced to what an unbacked claim is worth: it fell to around 22% of face, near $0.22, and Fantom's DeFi total value locked collapsed from roughly $364M to about $69M within days.",
  ...
  timeline: [
    ...
    {
      dateISO: "2023-07-06",
      headline: "Roughly $126–130M drains from the bridges",
  ...
  takeaways: [
    ...
    "On July 6, 2023, ~$126–130M drained from Multichain's bridges; Fantom-bridged USDC.m fell to ~$0.22 while native USDC never left par.",
