...
**Refer to `/agents/process/cmcs-base.md` while in cmcs workflow.**
...
- **`docs/worker-infrastructure.md`** — Env interface, cron scheduling (4 triggers, 18 primary jobs), edge cache, CORS, admin auth, alert system, undocumented cron details (charts, USDS, bluechip)
